...
void Contact::setcontact(std::string pb_first_name,std::string pb_last_name, std::string pb_nickname, std::string pb_phone_number, std::string pb_darkest_secret) {
